...
class DigitalOceanStorageService {
  ...
  constructor(bucketName, endpoint, accessKeyId, secretAccessKey, region) {
  ...
  */
   ...
   * @param {string} bucketName The filePath of the object
  ...
  */
  ...
  const bucketName =config.get('objectStorage.digitalOceanObjectStorage.bucket');
  const endpoint=config.get('objectStorage.digitalOceanObjectStorage.endpoint');
  const accessKeyId = config.get('objectStorage.digitalOceanObjectStorage.accessKeyId');
  const secretAccessKey=config.get('objectStorage.digitalOceanObjectStorage.secretAccessKey');
  const region = config.get('objectStorage.digitalOceanObjectStorage.region');


const digitalOceanStorageService = new DigitalOceanStorageService(bucketName, endpoint, accessKeyId, secretAccessKey, region);
